...
async def get_next_order_number() -> str:
    """Get the next sequential order number for purchase orders (e.g., PO-00000001, PO-00000002...)"""
    ...
    # Format: PO-00000001 (8 أرقام - يدعم حتى 99,999,999)
    return f"PO-{next_seq:08d}", next_seq
